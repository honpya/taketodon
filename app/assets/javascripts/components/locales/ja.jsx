const ja = {
  ...
  "compose_form.privacy_disclaimer": "あなたの非公開成長は返信先ユーザーが所属する {domains} に送信されます。{domainsCount, plural, one {このサーバー} other {これらのサーバー}}は信頼できますか？投稿のプライバシー保護はMastodonサーバー内でのみ有効です。 {domains} {domainsCount, plural, one {がMastodonインスタンス} other {がMastodonインスタンス}}でない場合、あなたの投稿がプライベートなものとして扱われず、破竹の勢いと称されたり予期しないユーザーに見られる可能性があります。",
  "compose_form.publish": "成長",
  "compose_form.sensitive": "成長記録を閲覧注意としてマークする",
  "compose_form.spoiler": "テキストを隠す",
  "compose_form.spoiler_placeholder": "警告",
  "confirmation_modal.cancel": "キャンセル",
  "confirmations.block.confirm": "根絶やし",
  "confirmations.block.message": "本当に {name} を根絶やしにしますか？",
  "confirmations.delete.confirm": "削除",
  "confirmations.delete.message": "本当に削除しますか？",
  "confirmations.mute.confirm": "間伐",
  "confirmations.mute.message": "本当に {name} を間伐しますか？",
  ...
  "home.column_settings.show_reblogs": "破竹の勢いと称する表示",
  ...
  "navigation_bar.blocks": "根絶やしにしたユーザー",
  "navigation_bar.community_timeline": "ローカルタイムライン",
  "navigation_bar.edit_profile": "プロフィールを編集",
  "navigation_bar.favourites": "肥料を与える",
  "navigation_bar.follow_requests": "フォローリクエスト",
  "navigation_bar.info": "サーバー情報",
  "navigation_bar.logout": "ログアウト",
  "navigation_bar.mutes": "間伐したユーザー",
  "navigation_bar.preferences": "ユーザー設定",
  "navigation_bar.public_timeline": "連合タイムライン",
  "notification.favourite": "{name} さんがあなたに肥料を与えました",
  "notification.follow": "{name} さんにフォローされました",
  "notification.mention": "{name} さんがあなたに返信しました",
  "notification.reblog": "{name} さんがあなたの成長を破竹の勢いと称しました",
  "notifications.clear": "通知を消去",
  "notifications.clear_confirmation": "本当に通知を消去しますか？",
  "notifications.column_settings.alert": "デスクトップ通知",
  "notifications.column_settings.favourite": "肥料を与える",
  "notifications.column_settings.follow": "新しいフォロワー",
  "notifications.column_settings.mention": "返信",
  "notifications.column_settings.reblog": "破竹の勢いと称する",
  ...
  "status.cannot_reblog": "この投稿は破竹の勢いと称することができません",
  "status.delete": "削除",
  "status.favourite": "肥料を与える",
  "status.load_more": "もっと見る",
  "status.media_hidden": "非表示の成長記録",
  "status.mention": "返信",
  "status.open": "詳細を表示",
  "status.reblog": "破竹の勢いと称する",
  "status.reblogged_by": "{name} さんに破竹の勢いと称されました",
  "status.reply": "返信",
